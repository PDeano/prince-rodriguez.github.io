# 7a923465-37f3-4a41-a5d1-5b49e41f38c7 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `mq4h99t7-portfolio.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `mq4h99t7-portfolio.html`
...
- A single self-contained `mq4h99t7-portfolio.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `mq4h99t7-portfolio.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `mq4h99t9-interview.mp4`
- `mq4h9ab6-gunita.mp4`
- `mq4h9azw-kapilas.mp4`
- `mq4h9bb0-obb11.mp4`
- `mq4h9bst-me.jpg`

## Coding checklist for AI tools
1. Inspect `mq4h99t7-portfolio.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
